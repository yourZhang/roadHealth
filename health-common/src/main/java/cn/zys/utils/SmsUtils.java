...
public class SmsUtils {
    ...
    // 需开发者指定
    private static String accessKeyId = "LTAI4G5HVVj5raic1FUsA2MA";

    // 需开发者指定
    private static String accessKeySecret = "KLNPMnK9Xd7h5zPZz3MUXV8AVwdkDs";
    ...
    public static void main(String[] args) throws Exception {
        SendSmsResponse sendSmsResponse = sendSms("17600116729", "", "SMS_200175394", "{\"code\":\"123456\"}");
